  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    fields.forEach(field => {
      if (['select', 'radio', 'checkbox'].includes(field.type)) {
        console.log(`Edit form - Field ${field.label} (${field.type}) options:`, field.options)
      }
    })
